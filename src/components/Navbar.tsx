  ...
  return (
    <>
      <div className="w-1/6 h-full flex flex-col justify-between bg-card-coolorsPrimary text-white p-4">
        <h2 className="lg:text-lg xl:text-2xl text-center mt-4 font-custom">
          MigrainePal
        </h2>
        <div className="flex-grow flex flex-col items-center">
          <Button className="mt-10 w-10/12 lg:w-full lg:text-sm xl:text-lg bg-foreground text-base flex items-center justify-start gap-2 pl-4">
            <Squares2X2Icon className="h-5 w-5" />
            <div className="flex-1 text-center">
              <Link to="/">Dashboard</Link>
            </div>
          </Button>
          <Button className="mt-6 w-10/12 lg:w-full lg:text-sm xl:text-lg bg-foreground text-base flex items-center justify-start gap-2 pl-4">
